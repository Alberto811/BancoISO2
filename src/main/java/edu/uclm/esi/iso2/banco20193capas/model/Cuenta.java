...
* que ha de tener al menos un {} que sea titular.
* 
* 
*/
@Entity
public class Cuenta {
	 ...
	 * @param cliente El cliente que se añade
	 * a la lista de titulares
	 * @throws CuentaYaCreadaException Si la cuenta
	...
	/**
	 * Retira el importe de la cuenta,
	 *  incluso aunque esta no tenga saldo suficiente
	 * @param importe	El importe que se retira
	...
	/**
	 * Realiza una transferencia desde 
	 * esta cuenta a la cuenta que se pasa como primer parámetro.
	...
	private Cuenta load(Long numero)
	throws CuentaInvalidaException {
	 ...
	 * @param nif	NIF del cliente para
	 * el que se emite la tarjeta
	...
	/**
	 * Emite una tarjeta de débito asociada a esta cuenta
	 * @param nif	El nif del cliente para
	 *  el cual se emite esta tarjeta
